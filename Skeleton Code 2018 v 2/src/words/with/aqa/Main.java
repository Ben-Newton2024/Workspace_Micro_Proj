...
public class Main {
    ...
    String getChoice()
    {
        ...
        Console.println("     press 2 to shuffle OR");
    ...
    public void shuffle(String playerTiles) {
    	Random rand = new Random();
    	//pos to ake the char at character from
    	int pos;
    	//bnew hand
    	String hand = "";
    	
    	//loop so long as hen each chracter is removed the length no longer is 0 
    	//if its zero then a random number cant be chosen
    	while(playerTiles.length()!=0) 
    	{	
    		pos = rand.nextInt(playerTiles.length());
    		//adding the new randomly selected character to hand
    		//characterAt(postion)
    		hand += playerTiles.charAt(pos);
    		//replacing the character taken with and eplty string place
    		playerTiles = playerTiles.replaceFirst(""+playerTiles.charAt(pos), "");
    	}
    	playerTiles = hand;
    	
    	Console.println(playerTiles);
    }
            ...
            int noOfEndOfTurnTiles)
    {
      ...
      while (!validChoice)
      {
        ...
        else if (choice.equals("2"))
        {
          ...
          shuffle(playerTiles.playerTiles);
    ...
    void displayMenu()
    {
      ...
      Console.println("3. Play a Custom game");
    ...
    void CustomMenu()
    {
      Console.println();
      Console.println("===========");
      Console.println("CUSTOM MENU");
      Console.println("===========");
      Console.println();
      Console.println("1. maxHandSize");
      Console.println("2. mazTilesPlayed");
      Console.println("3. noOfEndOfTurnTiles");
      Console.println("4. startHandSize");
      Console.println();
      Console.println("7. start game");
      Console.println();
      Console.println("9. Quit");
      Console.println();
    }  
      ...
      while(!choice.equals("9"))
      {
        ...
        else if (choice.equals("2"))
        {
          playGame(allowedWords, tileDictionary, false, 15, maxHandSize, 
        	...
        	String customMenuChoice = "";
        	
        	while (!customMenuChoice.equals("9"))
        	{
	            CustomMenu();
	            Console.println("Enter your choice: ");
	            customMenuChoice = Console.readLine();
	            
	        	if(customMenuChoice.equals("1")) {
	        		System.err.println("yeet");
	        		Console.println("Enter your Number: ");
		            String qwerty = Console.readLine();
		            maxHandSize = Integer.parseInt(qwerty);
	        	}
	        	else if(customMenuChoice.equals("2")) {
	        		Console.println("Enter your Number: ");
		            String qwerty = Console.readLine();
		            maxTilesPlayed = Integer.parseInt(qwerty);
	        	}
	        	else if(customMenuChoice.equals("3")) {
	        		Console.println("Enter your Number: ");
		            String qwerty = Console.readLine();
		            noOfEndOfTurnTiles = Integer.parseInt(qwerty);
	        	}
	        	else if(customMenuChoice.equals("4")) {
	        		Console.println("Enter your Number: ");
		            String qwerty = Console.readLine();
		            startHandSize = Integer.parseInt(qwerty);
	        	}        	
	        	
	        	else if(customMenuChoice.equals("7")) {
	        		playGame(allowedWords, tileDictionary, true, startHandSize, 
	                    maxHandSize, maxTilesPlayed, noOfEndOfTurnTiles);
	        	}
        	}
